    ...
    <div className="wrap" style={{ paddingBottom: 60 }}>
      ...
      <div className="cert-wrap">
        <div className="cert-doc">
          {cert.academia_logo && (
            <img src={cert.academia_logo} alt="" style={{ maxHeight: 48, maxWidth: 200, objectFit: "contain", margin: "0 auto 14px", display: "block" }} />
          )}
          ...
          <div className="cert-id mono">
            Emitido: {fecha} &nbsp;·&nbsp; ID: {params.id}
            {!esPart && cert.puntaje != null && <> &nbsp;·&nbsp; Puntaje: {cert.puntaje}%</>}
          </div>
        </div>
        ...
        <div className="cert-credit">
          <span className="lyceum-credit" style={{ marginTop: 0 }}>
            <LyceumMark size={14} />
