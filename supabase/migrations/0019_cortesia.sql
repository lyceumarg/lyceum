-- =====================================================================
-- 0019_cortesia.sql
-- Permite marcar UNA inscripción puntual como cortesía/gratuita, aunque
-- el curso tenga precio — independiente de si el curso entero es gratis.
-- =====================================================================

alter table enrollments add column if not exists cortesia boolean not null default false;
